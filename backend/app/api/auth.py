                ...
                <div style="background: white; border-radius: 32px; padding: 48px 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                    ...
                    <div style="text-align: center; margin-bottom: 40px;">
                        <div style="display: inline-flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                            <div style="background: #000; padding: 12px; border-radius: 12px; display: inline-block;">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M12 2a2 2 0 0 0-2 2v2H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-4V4a2 2 0 0 0-2-2z"/>
                                    <path d="M10 12h4"/>
                                    <path d="M12 10v4"/>
                                </svg>
                            </div>
